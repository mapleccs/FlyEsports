...
class RankInfo(ValueObject):
    ...
    def __post_init__(self):
        ...
        low_tier_ranks = {
            RankTier.IRON, RankTier.BRONZE, RankTier.SILVER, RankTier.GOLD,
            RankTier.PLATINUM, RankTier.EMERALD, RankTier.DIAMOND
        }
    ...
    def is_unranked(self) -> bool:
        ...
        return (self.tier == RankTier.IRON and 
                self.division == RankDivision.IV and 
