...
class MatchRecord(Entity):
    ...
    def __post_init__(self):
        ...
        stats_fields = [
            ...
            'damage_dealt', 'damage_taken', 'vision_score', 'game_duration'
        ]
        for field in stats_fields:
            value = getattr(self, field)
            if value < 0:
                raise BusinessRuleViolationError(f"{field} cannot be negative, got {value}")
    ...
    def kill_participation(self) -> float:
        ...
        return total_team_kills_assists  # This would need team data for proper calculation
    ...
    def __str__(self) -> str:
        ...
        return (f"MatchRecord({self.champion_name}, "
