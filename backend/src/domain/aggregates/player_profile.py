...
class PlayerProfile(AggregateRoot):
    ...
    def __post_init__(self) -> None:
        ...
        if self.description and len(self.description) > 500:
            raise BusinessRuleViolationError("Description cannot exceed 500 characters")
    ...
    def update_rating(
        self, new_rating: Rating, reason: str, match_id: Optional[str] = None
    ) -> None:
        """
    ...
    def sign_to_team(
        self, team_id: str, locked_rating: Optional[float] = None
    ) -> float:
        """
        ...
        lock_value = (
            locked_rating if locked_rating is not None else self.rating.current_score
        )
    ...
    def update_profile(
        self, player_name: Optional[str] = None, description: Optional[str] = None
    ) -> None:
        """
    ...
    def __str__(self) -> str:
        ...
        return (
            f"PlayerProfile({self.player_name}, "
